...
class ProfileConsumerVC: UIViewController {
    ...
    @IBAction func btnChangeMobileNum(_ sender: UIButton) {
        let vc = storyboard?.instantiateViewController(withIdentifier: "ChangeMobileConsumerVC") as! ChangeMobileConsumerVC
...
extension ProfileConsumerVC:UIImagePickerControllerDelegate,UINavigationControllerDelegate
{
...
extension ProfileConsumerVC:CropViewControllerDelegate
{
